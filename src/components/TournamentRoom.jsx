    ...
    return (
      <>
        ...
        <div className="tournament-room-page">
          <BackButton destination="/my-tournaments" buttonText="Back to My Tournaments" />
          <div className="signin-prompt-container">
            <div className="signin-hero">
              <div className="signin-icon">🎯</div>
              <h2 className="signin-title">Sign In to View Tournament Room</h2>
              <p className="signin-subtitle">Access tournament details and match information</p>
            </div>
      ...
      <>
        ...
        <div className="tournament-room-page">
          ...
          <div className="error-container">
            ...
            <Button onClick={() => navigate("/my-tournaments")} variant="primary">
          ...
          <div className="tournament-room-header">
            <div className="header-content">
              <div className="tournament-title-section">
                ...
                <div className="tournament-meta">
                  <span className="host-info">
                    Hosted by: {tournament.host?.display_name || tournament.host?.username || "Unknown Host"}
                  </span>
              ...
              <div className="participation-status">
                {isParticipant ? (
                  <span className="status-badge participant">✓ Participant</span>
                ) : (
                  <span className="status-badge not-participant">Not Participating</span>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="match-room-section">
            ...
            <div className="match-room-grid">
              <div className="match-room-card">
                ...
                <div className="card-content">
                  <div className="room-id-display">
                    <span className="room-id">{tournament.party_code || "TBD"}</span>
                  ...
                  <div className="room-status">
                    {tournament.party_code ? (
                      <span className="status-available">Party Code Available</span>
                    ) : (
              ...
              <div className="match-room-card">
                ...
                <div className="card-content">
                  <div className="server-region">{tournament.region || "Global"}</div>
                  <div className="server-details">Best connection for {tournament.region || "all"} players</div>
                </div>
              </div>
              ...
              <div className="match-room-card">
                ...
                <div className="card-content">
                  ...
                  <div className="platform-details">Cross-platform supported</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="section-header">
              ...
              <div className="section-icon">🏆</div>
               ...
               <div style={{
                 ...
                 <div style={{fontSize: '2rem'}}>👥</div>
                 <div style={{flex: 1}}>
                   <div style={{color: '#b0b0b0', fontSize: '0.9rem', marginBottom: '5px'}}>Participants</div>
                   <div style={{color: '#ffffff', fontSize: '1.2rem', fontWeight: '600'}}>
                     {tournament.current_players || 0} / {tournament.capacity || "Not set"}
                   </div>
                 </div>
               </div>
